...
public class DBProvider extends ContentProvider {
	...
	public Uri insert(Uri uri, ContentValues initialValues) {
        Log.i(THIS_FILE, "In DB provider -insert  match: ");
		int matched = URI_MATCHER.match(uri);
	...
	public Cursor query(Uri uri, String[] projection, String selection,
        ...
        Log.i(THIS_FILE, "In DB provider - query: ");
	...
	public int update(Uri uri, ContentValues values, String where, String[] whereArgs) {
        Log.i(THIS_FILE, "In DB provider -insert  update: ");
        SQLiteDatabase db = mOpenHelper.getWritableDatabase();
        int count;
        String finalWhere;
        int matched = URI_MATCHER.match(uri);
	...
	private void broadcastAccountChange(long accountId) {
        Log.i(THIS_FILE, "sending  Account Broadcast broadcastAccountChange(): ");
        ...
        Log.i(THIS_FILE, "sent  Account Broadcast broadcastAccountChange(): ");
	...
	private void broadcastRegistrationChange(long accountId) {
        Log.d("DBProvider","inside broadcastRegistrationChange()" );
