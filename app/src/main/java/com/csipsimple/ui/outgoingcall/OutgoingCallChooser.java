...
public class OutgoingCallChooser extends AppCompatActivity {
    ...
    private void connectService() {
        ...
        if (prefsWrapper.isValidConnectionForOutgoing()) {
            ...
            bundle.putParcelable(SipManager.EXTRA_OUTGOING_ACTIVITY, getComponentName());
            sipService.putExtra("EXTRA_OUTGOING_ACTIVITY",bundle);

          //  sipService.putExtra(SipManager.EXTRA_OUTGOING_ACTIVITY, getComponentName());
            getApplicationContext().startService(sipService);
