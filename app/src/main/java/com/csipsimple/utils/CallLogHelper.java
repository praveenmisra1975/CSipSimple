...
public class CallLogHelper {
	...
	public static ContentValues logValuesForCall(Context context, SipCallSessionImpl call, long callStart) {
		...
		if(call.isIncoming()) {
			...
			if(callStart > 0) {
				...
				nonAcknowledge = 0;
			}else if(call.getLastStatusCode() == SipCallSessionImpl.StatusCode.DECLINE ||
			        call.getLastStatusCode() == SipCallSessionImpl.StatusCode.BUSY_HERE ||
