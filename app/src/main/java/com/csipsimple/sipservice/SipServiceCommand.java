...
public class SipServiceCommand implements SipServiceConstants {
     ...
     */
    public static String setAccount(Context context, SipProfile sipAccount) {
        if (sipAccount == null) {
            throw new IllegalArgumentException("sipAccount MUST not be null!");
        }
        PjSipAccount  pjSipAccount =new PjSipAccount(sipAccount);
        String accountID = pjSipAccount.getIdUri();
     ...
     * @return sip account ID uri as a string
     */
    public static String setAccountWithCodecs(Context context, SipProfile sipAccount,
