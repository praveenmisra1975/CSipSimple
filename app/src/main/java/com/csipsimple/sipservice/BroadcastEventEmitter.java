...
public class BroadcastEventEmitter implements SipServiceConstants {
    ...
    public static String NAMESPACE = "com.csipsimple";
    ...
    public void callStats(int callID, int duration, String audioCodec, int callStateStatus, RtpStreamStats rx, RtpStreamStats tx) {
        final Intent intent = new Intent()
    ...
    public void callReconnectionState(CallReconnectionState state) {
        final Intent intent = new Intent();
    ...
    public void silentCallStatus(boolean status, String number) {
        final Intent intent = new Intent();
